...
Clone this repository to your desired folder:
  ...
  cd my-folder
  git clone https://github.com/samuelkinyanjui/Hello-Microverse
...
- GitHub: [@githubhandle](https://github.com/samuelkinyanjui/Hello-Microverse)
